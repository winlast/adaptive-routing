...
- [Адаптивная маршрутизация запросов между синхронным и асинхронным веб-движками на основе классификатора нагрузки: оценка практической целесообразности](docs/Статья про адаптивную маршрутизацию запросов Синявский СД и Галюк СВ.docx)
- [Презентация](docs/Презентация про адаптивную маршрутизацию запросов Синявский СД и Галюк СВ.pptx)
