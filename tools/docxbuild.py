...
свойствами, что в уже сданных файлах, — Times New Roman 12 пт,
межстрочный интервал 1,5, отступ первой строки 709 твипов, выключка по
ширине, висячий отступ 567 у источников. Шапка документа (УДК,
заголовок, автор, организация, аннотация, ключевые слова) переносится
из оригинала дословно, потому что аннотация уже подана и менять её
нельзя.
"""
